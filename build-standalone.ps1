...
Write-Host "`nBuild complete! Standalone executables are in the 'dist' folder:" -ForegroundColor Green
...
Write-Host "`nTo use the standalone executable:" -ForegroundColor Yellow
